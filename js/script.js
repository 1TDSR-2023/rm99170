...
// //Inserir um item ao final do array com o método push();
// frutas.push("manga");
// console.log(frutas);
...
// //Remover um item do início do array com o método pop();
// frutas.shift();
// console.log(frutas);
...
// //O método splice() recebe dois parâmetros, o índice do item que será removido e a quantidade de vezes que este mesmo índice será removido. Ex: splice(ìndice, 1);
// //Dica: Utilize o método indexOf() para buscar o índice do item no array. 

// let indice = frutas.indexOf("melancia");
// console.log(`O item encontraddo antes da remoção foi: ${frutas[indice]} `);
